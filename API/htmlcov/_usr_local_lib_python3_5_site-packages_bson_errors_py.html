...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.5/site-packages/bson/errors.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.5/site-packages/bson/errors.py</b> :
