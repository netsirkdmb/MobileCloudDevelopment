...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.5/site-packages/pymongo/monotonic.py: 85%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.5/site-packages/pymongo/monotonic.py</b> :
...
<p id="t36" class="stm mis">        <span class="key">from</span> <span class="nam">time</span> <span class="key">import</span> <span class="nam">time</span><span class="strut">&nbsp;</span></p>
